...
\author{Tanguy Bozec\inst{1,2}\orcid{TODO} \and
...
type variables, up to \(n^v\) monomorphising substititions may be generated. Recall that the total number of type argument tuples that are used to generate \(S(\varphi)\) can be doubly exponential in the number of loop iterations.
\end{enumerate}
...
\footnote{\url{https://nekoka-project.github.io/pubs/monomorphisation_data.zip}}
