...
These iterations are required to generate all 

After a set number of iterations, the new type arguments are used to instantiate type variables, generating new monomorphic clauses.
...
This approach sacrifices completeness for the sake of performance. The loss of completeness occurs at the conceptual level due to the finite number of iterations. It also occurs on the practical level, due to the explosive nature of the procedure, various bounds limit the number of generated clauses.
