...
The set of substitutions generated in this way is then iterated over, and each substitution is tentatively applied to all polymorphic type arguments. The application of a substitution to a tuple of polymorphic type arguments takes place only if least one type variable in the tuple is instantiated by the substitution. This condition filters out all substitution application that would have otherwise left all type arguments unchanged.
