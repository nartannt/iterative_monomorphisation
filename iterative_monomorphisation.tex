...
Table~\ref{nmon_ty_args} fills the same role as table~\ref{mono_ty_args} except it is for bounds limiting the number of new non-monomorphic type arguments. The bound values are lower because we found non-monomorphic type arguments to be explosive in preliminary evaluations. These results confirm that non-monomorphic argument generation drive the creation of useful non-monomorphic clauses. This is indicatied by the very low number of problems solved when no new non-monomorphic type arguments are allowed. Performance of the monomorphisation algorithm seems largely unaffected by bounds' values when within a certain range but drops off significantly beyond this range.
%TODO check that 124 is what we get if we just run Zipperposition for 10 seconds (maybe with all additionnal problems that are easily monomorphised)
...
\centering\begin{tabular}{@{}l*{12}{>{\centering\arraybackslash}p{1.5em}}@{}}
   ...
   \cmidrule(lr){2-5}\cmidrule(lr){6-9}\cmidrule(l){10-13}
   %2          & 158 & 158 & 158 & 158& 169 & 169 & 169 & 169& 167 & 170 & 170 & 171\\
   5          & 158 & 158 & 158 & 158& 169 & 169 & 169 & 169& 167 &\bf{171}&170&171\\
   50         & 158 & 158 & 158 & 158& 169 & 169 & 169 & 169& 167 & 170 & 170 & 171\\
   100        & 158 & 158 & 158 & 158& 169 & 169 & 169 & 169& 167 & 170 & 170 & 171\\
   %200        & 158 & 158 & 158 & 158& 169 & 169 & 169 & 169& 167 &\bf{171}&170&171\\
...
Table \ref{pb_size} groups together the bounds related to the size of the output problem to be passed to the E prover. The absolute cap is the maximum number of formulae passed to E. The multiplier limits the total number of newly generated formulae based on the problem's initial number of formulae. The performance of the E prover is highly dependent on the number of formulae it is given. To account for this, we test the effects of the amount of time allocated to E on the monomorphised problem against the size of the monomorphised problem. We expect degraded performance when E is given many formulae but little time and few formulae but a lot of time.
