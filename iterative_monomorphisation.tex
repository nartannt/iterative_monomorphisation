...
\begin{enumerate}
   ...
   \item The \emph{mono\_substs} function is the most explosive part of the algorithm. For a formula \(\varphi\), if \(S(\varphi)\) contains \(n\) substitutions that each instantiate exactly one of \(v\) %different
