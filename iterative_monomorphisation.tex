...
This algorithm is implemented in Zipperpostion, a higher order polymorphic automatic theorem prover written in OCaml. This implementation allows for the E prover, which does not support polymorphism, to be used as a backend to Zipperposition. The viability of this approach is then evaluated, both as an improvement to Zipperposition and as a means to increase the performance of other provers.
