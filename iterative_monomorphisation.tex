...
%The substitution %$\{\alpha_1\mapsto\tau_1, \dots, \alpha_n\mapsto\tau_n\}$
%is \emph{monomorphising} if the types $\tau_i$ are all monomorphic.
\end{definition}
...
% and, on success, obtain a monomorphising substitution.
